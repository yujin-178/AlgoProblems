...
public class Main2 {
    ...
    static LinkedList<Person> queue;
    static int N;
    ...
    public static void main(String[] args) throws IOException {
        ...
        Collections.sort(queue, (o1, o2) ->Integer.compare(o1.arrival, o2.arrival));
